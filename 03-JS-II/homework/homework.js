...
function esEntero(numero) {
  ...
  else if (resultado == false) {return false}
...
function fizzBuzz(numero) {
  ...
  var division3 = numero % 3;
  var division5 = numero % 5;
  if (division3 ===0 && division5 === 0){return "fizzbuzz";}
  else if (division5 === 0){return "buzz";}
  else if (division3 === 0){return "fizz";}
  else{return numero;}
